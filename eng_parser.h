    ...
    array<str> entries (eng::vocabulary& voc, str input, bool casesensitive)
    {
        ...
        for (auto line: input.split_by("<br>"))
        {
            ...
            for (auto m: matches(voc, tokens))
            {
                ...
                or (m.text == "..." and input.size() > 9*5)
                or (m.text == "1"   and input.size() > 9*5)
                or (m.text == "2"   and input.size() > 9*5)
                or (m.text == "3"   and input.size() > 9*5)

                or (m.text == "a"   and input.size() > 3*5)
                or (m.text == "an"  and input.size() > 4*5)
                or (m.text == "the" and input.size() > 4*5)
                ...
                or (m.text == "me"   and input.size() > 9*5)
                ...
                or (m.text == "your" and input.size() > 9*5)
                ...
                or (m.text == "are"    and input.size() > 9*5)
                or (m.text == "at"     and input.size() > 9*5)
                or (m.text == "be"     and input.size() > 9*5)
                or (m.text == "but"    and input.size() > 5*5)
                or (m.text == "can"    and input.size() > 9*5)
                or (m.text == "do"     and input.size() > 3*5)
                or (m.text == "don"    and input.size() > 9*5)
                or (m.text == "don'"   and input.size() > 9*5)
                or (m.text == "don't"  and input.size() > 9*5)
                ...
                or (m.text == "of"     and input.size() > 4*5)
                or (m.text == "oh"     and input.size() > 9*5)
                or (m.text == "on"     and input.size() > 9*5)
