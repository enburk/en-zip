    ...
    array<str> entries (eng::vocabulary& voc, str input)
    {
        ...
        for (auto line: input.split_by("<br>"))
        {
            ...
            for (auto m: matches(voc, tokens))
            {
                ...
                or (m.text == "it"   and input.size() > 4*5)
                or (m.text == "of"   and input.size() > 4*5)
                or (m.text == "no"   and input.size() > 4*5)
                or (m.text == "so"   and input.size() > 5*5)
                or (m.text == "that" and input.size() > 4*5)
