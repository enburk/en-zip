    ...
    widget<search>
    {
        ...
        void on_change (void* what) override
        {
                ...
                coord.now.size)
            {
                ...
                related_items.coord = xywh(x, y, W/4, h); y += h; x = 0;

                Wordlistfile.coord = xywh(0, y, W, h); y += h;
                wordlistfile.coord = xywh(0, y, W, h); y += h;

                recursive.coord = xywh(x, y, W/4, h); x += W/4;
                synonyms .coord = xywh(x, y, W/4, h); x += W/4;
                antonyms .coord = xywh(x, y, W/4, h); x += W/4;
                hypernyms.coord = xywh(x, y, W/4, h); y += h; x = 0;

                hyponyms .coord = xywh(x, y, W/4, h); x += W/4;
                meronyms .coord = xywh(x, y, W/4, h); x += W/4;
                holonyms .coord = xywh(x, y, W/4, h); x += W/4;
                troponyms.coord = xywh(x, y, W/4, h); y += h; x = 0;
