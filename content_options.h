    ...
    struct options
    {
        ...
        options (str text)
        {
            for (str s: text.split_by("#"))
            {
                ...
                static array<str> internals = str("DEL, pix-, pix?, audio-, sound-, uk-, us-, +ru, uk+us, uk|us, duple, sic!").split_by(", ");
                static array<str> externals = str("1, 2, 3, 4, Ru, HEAD, POEM, SOUND, T, F, Q, uk+us, "
